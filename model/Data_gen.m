...
for i=1:iterations
    ...
    vnet_fieldnames = strcat('/home/maryam/Desktop/temp/',num2str(i),'Vnet.mat');
    conc_fieldnames = strcat('/home/maryam/Desktop/temp/',num2str(i),'concentration_perturb.mat');
    ...
    x1_file = strcat('/home/maryam/Desktop/temp/',num2str(i),'reactions.mat');
    x2_file = strcat('/home/maryam/Desktop/temp/',num2str(i),'perturbations.mat');
