...
function [concentration_perturb]=main_module(x1,x2,growth_condition)
...
fprintf('\n-------------------------------\n');
       ...
       % Integration of ODEs
       [concentration_perturb] = solve_ode2(network_data,t_interval,y0,elementary_kinetic_parameter);
