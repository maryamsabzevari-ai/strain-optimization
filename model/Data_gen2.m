...
for i=1:iterations
    ...
    vnet_fieldnames = strcat('./Data_gen/sec',num2str(i),'Vnet.mat');
    conc_fieldnames = strcat('./Data_gen/sec',num2str(i),'concentration_perturb.mat');
    ...
    x1_file = strcat('./Data_gen/sec',num2str(i),'reactions.mat');
    x2_file = strcat('./Data_gen/sec',num2str(i),'perturbations.mat');
