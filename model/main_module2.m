...
function [concentration_perturb]=main_module2(x1,x2,growth_condition)
...
fprintf('\n-------------------------------\n');
       ...
       % Integration of ODEs
       [vnet,concentration_perturb] = solve_ode(network_data,t_interval,y0,elementary_kinetic_parameter);
