function [Error_vec, res_vec ] = std_stat2()
...
for i = 1:iterations
    ...
    conc_file = strcat('./temp2/',num2str(i),'conc_res.mat');
    Error_file = strcat('./temp2/',num2str(i),'Error_vec.mat');
    res_file = strcat('./temp2/',num2str(i),'res_vec.mat');
